...
proc createDiver { id } {
    ...
    global ns cbr_diver cbr2_diver cbr3_diver cbr4_diver position_diver node_diver udp portnum_diver portnum2_diver ipr_diver ipif_diver ipr2_diver ipif2_diver
    ...
    global db_manager node_diver_coordinates
    ...
    set udp2_diver($id)  [new Module/UW/UDP]
    set ipr2_diver($id)  [new Module/UW/FLOODING]
    set ipif2_diver($id) [new Module/UW/IP]
    ...
    $node_diver($id) setConnection $cbr3_diver($id)  $udp_diver($id)   0
    ...
    $node_diver($id) setConnection $cbr4_diver($id)  $udp2_diver($id)   0
    $node_diver($id) setConnection $udp2_diver($id)  $ipr2_diver($id)   0
    $node_diver($id) setConnection $ipr2_diver($id)  $ipif2_diver($id)  2
    $node_diver($id) setConnection $ipif2_diver($id) $ctr_diver($id)   2
    ...
    set portnum2_diver($id) [$udp_diver($id) assignPort $cbr2_diver($id) ]
    set portnum3_diver($id) [$udp_diver($id) assignPort $cbr3_diver($id) ]
    set portnum4_diver($id) [$udp2_diver($id) assignPort $cbr4_diver($id) ]
    if {$id > 254} {
    ...
    $ipif2_diver($id) addr $tmp_
    $ipr2_diver($id) addr $tmp_
    
    set position_diver($id) [new "Position/BM"]
    ...
    $interf_data_hf($id) set debug_       0
    ...
    $ctr_diver($id) setBufferFeatures 1 500 0 0
    $ctr_diver($id) setBufferFeatures 2 500 0 0
    $ctr_diver($id) setBufferFeatures 3 500 0 0
    $ctr_diver($id) setBufferFeatures 4 500 0 0

...
proc createROV { id } {
    ...
    global portnum_rov portnum2_rov portnum3_rov ipr_rov ipif_rov ipr2_rov ipif2_rov
    ...
    global mac_op_rov db_manager node_rov_coordinates portnum4_rov
    ...
    set udp2_rov  [new Module/UW/UDP]
    set ipr2_rov  [new Module/UW/FLOODING]
    set ipif2_rov [new Module/UW/IP]
    ...
    $node_rov addModule 7 $udp2_rov   0  "UDP2"
    $node_rov addModule 6 $ipr2_rov   0  "IPR2"
    $node_rov addModule 5 $ipif2_rov  2  "IPF2" 
    ...
    for {set id1 0} {$id1 <= $opt(n_diver)} {incr id1} {
        $node_rov setConnection $cbr4_rov($id1)  $udp2_rov   0
    }
    $node_rov setConnection $udp2_rov  $ipr2_rov   0
    $node_rov setConnection $ipr2_rov  $ipif2_rov  2
    $node_rov setConnection $ipif2_rov $ctr_rov   2
    ...
    for {set id1 0} {$id1 <= $opt(n_diver)} {incr id1} {
        ...
        set portnum4_rov($id1) [$udp2_rov assignPort $cbr4_rov($id1) ]
    }
    set portnum2_rov [$udp_rov assignPort $cbr2_rov ]
    ...
    set position_rov [new "Position/BM"]
    ...
    $ctr_rov setBufferFeatures 1 50 0 0
    $ctr_rov setBufferFeatures 2 50 0 0
    $ctr_rov setBufferFeatures 3 50 0 0
    $ctr_rov setBufferFeatures 4 50 0 0

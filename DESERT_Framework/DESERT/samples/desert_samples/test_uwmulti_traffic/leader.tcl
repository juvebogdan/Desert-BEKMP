...
proc createLeader { id } {
    ...
    global portnum_leader portnum2_leader portnum3_leader ipr_leader ipif_leader ipr2_leader ipif2_leader
    ...
    global mac_op_leader db_manager node_leader_coordinates
    ...
    set udp2_leader  [new Module/UW/UDP]
    set ipr2_leader  [new Module/UW/FLOODING]
    set ipif2_leader [new Module/UW/IP]
    ...
    $node_leader addModule 7 $udp2_leader   0  "UDP2"
    $node_leader addModule 6 $ipr2_leader   0  "IPR2"
    $node_leader addModule 5 $ipif2_leader  2  "IPF2" 
    ...
    $node_leader setConnection $cbr4_leader  $udp2_leader   0
    $node_leader setConnection $udp2_leader  $ipr2_leader   0
    $node_leader setConnection $ipr2_leader  $ipif2_leader  2
    $node_leader setConnection $ipif2_leader $ctr_leader   2
    ...
    for {set id1 0} {$id1 <= $opt(n_diver)} {incr id1} {
        set portnum2_leader($id1) [$udp_leader assignPort $cbr2_leader($id1) ]
    }
    set portnum3_leader [$udp_leader assignPort $cbr3_leader ]
    set portnum4_leader [$udp2_leader assignPort $cbr4_leader ]
    if {$id > 254} {
    ...
    $ipif2_leader addr $tmp_
    $ipr2_leader addr $tmp_
    
    set position_leader [new "Position/BM"]
    ...
    $ctr_leader setBufferFeatures 1 50 0 0
    $ctr_leader setBufferFeatures 2 50 0 0
    $ctr_leader setBufferFeatures 3 50 0 0
    $ctr_leader setBufferFeatures 4 50 0 0
